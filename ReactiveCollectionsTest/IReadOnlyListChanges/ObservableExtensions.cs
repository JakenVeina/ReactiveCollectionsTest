...
namespace ReactiveCollectionsTest.IReadOnlyListChanges
{
    public static class ObservableExtensions
    {
                    ...
                    .Select(changeSet =>
                    {
                        switch(changeSet.Type)
                        {
                            ...
                            case ChangeSetType.Reset:
                                {
                                    var newSortedItems = new List<TItem>(capacity: changeSet.Changes.Count - sortedItems.Count);
                            ...
                            case ChangeSetType.Update:
                                {
                                    var changes = new List<SortedChange<TItem>>(capacity: changeSet.Changes.Count);
                    ...
                    Func<TIn, TOut>                     itemSelector)
        {
            ...
            {
                var changes = new List<SortedChange<TOut>>(capacity: changeSet.Changes.Count);
        ...
        public static IObservable<KeyedChangeSet<TKey, TValue>> WhereItems<TKey, TValue>(
            ...
            => source.SelectSome<KeyedChangeSet<TKey, TValue>, KeyedChangeSet<TKey, TValue>>((changeSet, onNext) =>
            {
                switch(changeSet.Type)
                {
                    case ChangeSetType.Clear:
                        {
                            var changes = new List<KeyedChange<TKey, TValue>>(capacity: changeSet.Changes.Count);
